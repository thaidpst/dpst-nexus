...
router.get('/download/:formId', (req, res) => {
  ...
  dbSubmittedGovForms.findOne({ _id: formId })
    .then(data => {
      var srcPdf = 'public/forms/formpdfForm-1526954177737.pdf';
      var dstPdf = 'public/forms/filled/' + formId + '.pdf';
      // var pdfFiller = require('pdfFiller');
      // var shouldFlatten = false;
      // var formValue = { 'contract-no': data.formValue['contract-no'], acadyear: '2561หs' };
      // // var formValue = data.formValue;
      // console.log(formValue);
      // pdfFiller.fillFormWithOptions(srcPdf, dstPdf, formValue, shouldFlatten, 'public/forms/filled', function (err) {
      //   console.log("In callback.");
      //   if (err) {
      //     console.log(err);
      //   }
      // });
      var file = fs.createReadStream(dstPdf);
      var stat = fs.statSync(dstPdf);
      console.log('pdf sending', stat.size);
